...
def do_forward(robot_name, steps):
    ...
    elif steps < min_x or steps < min_y or steps > max_y or steps > max_x:
...
def do_right_turn(robot_name):
    ...
    if len(sys.argv) == 1 or sys.argv[1] == "text":
        ...
        world.text.world.current_direction_index += 1
    
    elif sys.argv[1] == "turtle":
        import world.turtle.world
        world.turtle.world.hal.rt(90)
...
def handle_command(robot_name, command):
    ...
    print(command_output) #hal moved by something steps
    show_position(robot_name)
...
def robot_start():
    ...
    clear.position_x = 0
    clear.position_y = 0
    clear.current_direction_index = 0
    history = []
